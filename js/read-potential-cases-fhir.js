...
(async () => {
  ...
  await fs.writeFile("nonrheumatic-aortic-valve-disorders-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("nonrheumatic-aortic-valve-disorders-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
